...
def dashboard():
    ...
    try:
        ...
        total_en_attente_global_liste_attente = 0
        ...
        for s_obj in sessions_from_db:
            try:
                ...
                total_en_attente_global_liste_attente += attente_count
                if places_rest == 0:
        ...
        return render_template('dashboard.html',
                              ...
                              total_en_attente=total_en_attente_global_liste_attente,
                              ...
                              # MODIFICATION ICI : Passer les dictionnaires Python directement
